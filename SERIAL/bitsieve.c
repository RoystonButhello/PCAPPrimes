//Algorithm 3B.1 - Sequential Prime Sieve Using Bitwise Representation for Space Efficiency
#include <stdlib.h>
#include <string.h>
#include <stdio.h>
#include <math.h>
...
int main()
{
	...
	// E09		60MB     42s
	// E10	   257MB    198s
	//Using new method, finding primes upto E10 took up 257MB of RAM and ~198 seconds
	...
	integer m = (n > ceil) ? ceil : n;	//Calculate primes upto m using phase 1, and primes>m using phase 2	
